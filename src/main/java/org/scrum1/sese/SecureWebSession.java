	...
	public boolean authenticate(String username, String password) {
		try {
			...
			if(auth.isAuthenticated()) {
				// the authentication object has to be stored in the SecurityContextHolder and in the HttpSession
				// so the security context will be accessible in the next request
