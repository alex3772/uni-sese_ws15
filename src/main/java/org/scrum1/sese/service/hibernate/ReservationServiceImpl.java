...
import org.scrum1.sese.repository.specification.ReservationCustomerNameSpecification;
import org.scrum1.sese.repository.specification.ReservationRoomNameSpecification;
...
public class ReservationServiceImpl implements ReservationService {
	...
	public List<Reservation> findByCustomerName(String customerName) {
		return toList(reservationRepository.findAll(new ReservationCustomerNameSpecification(customerName)));
	}

	@Override
	@Transactional(readOnly = true)
	public List<Reservation> findByRoomName(String roomName) {
		return toList(reservationRepository.findAll(new ReservationRoomNameSpecification(roomName)));
	}
	...
	public List<Reservation> findAll(String customerName, String roomName) {
		ReservationCustomerNameSpecification customerSpec = new ReservationCustomerNameSpecification(customerName);
		ReservationRoomNameSpecification roomSpec = new ReservationRoomNameSpecification(roomName);
		return toList(reservationRepository.findAll(Specifications.where(customerSpec).and(roomSpec)));
	}
